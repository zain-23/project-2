...
export default function EcomerceStore() {
  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false);
  const [allProducts, setAllProducts] = useState([]);
  const { handleCart } = useContext(ContextData);
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              {/* Filters */}
              <form className="hidden lg:flex lg:flex-col lg:gap-y-4 px-2 py-4 h-auto">
                <h3 className="sr-only">Categories</h3>
                <ul
                  role="list"
              ...
              <div className="lg:col-span-3 h-auto">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-4 gap-y-10">
                  {allProducts.map((data) => (
                    <>
                      <div
                        className="group group-hover:bg-opacity-60 transition rounded-md duration-500 relative bg-gray-50 h-80 flex justify-center items-center bg-center bg-no-repeat"
                        style={{
                          backgroundImage: `url(https://i.ibb.co/zP9sWqP/phillip-goldsberry-f-Zule-Efe-A1-Q-unsplash-1-removebg-preview-1.png)`,
                        }}
                      >
                        <div className="absolute sm:top-8 top-4 flex gap-x-20 justify-between items-center">
                          <div>
                            <p className="group-hover:opacity-60 transition duration-500 text-md leading-5 text-gray-600">
                              {data?.productName}
                            </p>
                          </div>
                          <div>
                        ...
                        <div className="flex items-center bottom-8 gap-x-40 justify-between absolute opacity-0 group-hover:opacity-100 transition duration-500">
