...
const AddBlog = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("/api/blog/addblogs", formData);
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-gray-400">
                      <input
                        ...
                        id="Title"
                        autoComplete="Title"
                        className="block flex-1 bg-transparent rounded-md py-1.5 pl-1 text-gray-800 outline-none placeholder:text-gray-400 bg-white sm:text-sm sm:leading-6"
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2 flex justify-center ring-1 ring-gray-400 rounded-lg border border-dashed border-white px-6 py-10">
                    <div className="text-center">
                      <PhotoIcon
                        className="mx-auto h-12 w-12 text-gray-300"
                        aria-hidden="true"
                      />
                      <div className="mt-4 flex text-sm leading-6 text-black items-center">
                        <label
                          htmlFor="file-upload"
              ...
              <div className="mt-6">
                <button
                  type="submit"
                  className="rounded-md ring-1 ring-gray-400 bg-white px-3 w-full py-2 text-sm font-semibold text-grasy-600 shadow-sm outline-none"
                >
                  Save
                </button>
              </div>
