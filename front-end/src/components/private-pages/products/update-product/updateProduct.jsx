...
const UpdateProduct = () => {
  const { product, updateId } = useContext(ContextData);
  ...
  const [formData, setFormData] = useState({
    ...
    productCotegory: product?.productCotegory,
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(
        `/api/product/updateproduct/${updateId}`,
        formData
      );
      if (response.data) {
        handleModal();
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border  border-white ring-1  ring-gray-400  px-6 py-10">
